...
execute unless score $is_server smithed.actionbar.temp matches 1.. run function smithed.actionbar:v0.6.4/vanilla/bed/get_server_status
...
execute if score $is_server smithed.actionbar.temp matches 1 if score $sleeping_percent smithed.actionbar.temp matches ..100 run function smithed.actionbar:v0.6.4/vanilla/bed/send_sleep_status
