...
execute if score .10 slow_tick matches 10 store result score .cauldron temp run function ancient_artifacts:artifact_smith/check_cauldron
execute if score .10 slow_tick matches 10 unless score .cauldron temp matches 1 run tag @s add no_restock
execute if score .10 slow_tick matches 10 if score .cauldron temp matches 1 run tag @s remove no_restock
