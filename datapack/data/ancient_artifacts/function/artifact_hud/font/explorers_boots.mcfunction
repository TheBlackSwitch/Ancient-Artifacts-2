...
execute if score .frame temp matches 13 run data modify storage ancient_artifacts:hud text append value '{"text":"\\u0030","font":"minecraft:artifact_hud"}'
execute if score .frame temp matches 14 run data modify storage ancient_artifacts:hud text append value '{"text":"\\u0031","font":"minecraft:artifact_hud"}'
