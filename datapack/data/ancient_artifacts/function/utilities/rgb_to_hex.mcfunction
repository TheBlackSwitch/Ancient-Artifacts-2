...
# =floor(red / 16) 
scoreboard players operation .rMs temp /= .16 const
...
# =floor(red / 16) 
scoreboard players operation .rLs temp %= .16 const
...
# =floor(red / 16) 
scoreboard players operation .gMs temp /= .16 const
...
# =floor(red / 16) 
scoreboard players operation .gLs temp %= .16 const
...
# =floor(red / 16) 
scoreboard players operation .bMs temp /= .16 const
...
# =floor(red / 16) 
scoreboard players operation .bLs temp %= .16 const
