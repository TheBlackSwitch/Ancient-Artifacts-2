...
execute if score @s cutscene matches 60..76 as @e[tag=dungeon_entrance,sort=nearest,limit=1,distance=..1000] run function ancient_artifacts:dungeon/cutscene/animate_statue
...
execute if score @s cutscene matches 280..285 if score .3 slow_tick matches 3 positioned ^ ^-3 ^7 run function ancient_artifacts:dungeon/cutscene/summon_animation
