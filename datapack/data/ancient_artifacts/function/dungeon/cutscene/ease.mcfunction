...
scoreboard players operation .3 temp *= .1000 const
scoreboard players operation .3 temp /= .2 temp
scoreboard players operation .3 temp /= .2 const

#Calc ab
scoreboard players operation .4 temp = .3 temp
scoreboard players operation .4 temp *= .2 temp 
scoreboard players operation .4 temp /= .1000 const
...
#Calc |x-ab|
execute if score .5 temp matches ..-1 run scoreboard players operation .5 temp *= .-1 const
...
#Calc f(x)
scoreboard players operation .7 temp *= .1000 const
