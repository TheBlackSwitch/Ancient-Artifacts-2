...
execute if score .3 slow_tick matches 3 as @a if items entity @s weapon.mainhand echo_shard[minecraft:custom_data~{"ancient_hammer":1b}] run item modify entity @s weapon.mainhand ancient_artifacts:hammer_repair_cost
execute if score .3 slow_tick matches 3 as @a if items entity @s player.cursor echo_shard[minecraft:custom_data~{"ancient_hammer":1b}] run item modify entity @s player.cursor ancient_artifacts:hammer_repair_cost