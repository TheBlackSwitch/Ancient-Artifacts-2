...
##give artifacts trigger
scoreboard players enable @a ancient_artifacts_give
execute as @a[gamemode=!creative,scores={ancient_artifacts_give=1..}] run tellraw @s {"text": "You need to be in creative mode to activate this!", "color": "red"}
execute as @a[gamemode=!creative,scores={ancient_artifacts_give=1..}] at @s run playsound minecraft:block.note_block.didgeridoo master @s ~ ~ ~ 1 0.7
execute as @a[gamemode=creative,scores={ancient_artifacts_give=1..}] at @s run function ancient_artifacts:give_items
scoreboard players set @a ancient_artifacts_give 0
