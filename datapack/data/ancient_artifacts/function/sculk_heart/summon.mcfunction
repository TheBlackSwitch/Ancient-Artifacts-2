##Wave boss bar
#init
$execute if score @s animation matches 22 run bossbar add sculk_heart_$(UUID1)_$(UUID2)_$(UUID3)_$(UUID4) {"text":"\uE517","color":"#4e5c24"}
...
$execute if score @s animation matches 22 run bossbar add sculk_heart_space_$(UUID1)_$(UUID2)_$(UUID3)_$(UUID4) {"text":"","color":"#4e5c24"}
#update values
