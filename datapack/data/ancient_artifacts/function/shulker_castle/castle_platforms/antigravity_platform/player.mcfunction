...
execute if data storage ancient_artifacts:player {active_effects:[{id:"minecraft:unluck",amplifier:2b}]} run attribute @s gravity modifier add antigravity -0.30 add_multiplied_base
execute if data storage ancient_artifacts:player {active_effects:[{id:"minecraft:unluck",amplifier:3b}]} run attribute @s gravity modifier add antigravity -0.50 add_multiplied_base
