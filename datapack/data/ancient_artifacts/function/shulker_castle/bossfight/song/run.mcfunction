...
execute if score @s shulker_king_music_timer matches 10 at @s run playsound ancient_artifacts:music.shulker_king.intro record @s ~ ~ ~ 0.50 1
execute if score @s shulker_king_music_timer matches 10 run tag @s add shulker_king_music_phase_1


execute if score @s shulker_king_music_timer matches 4290.. at @s[tag=shulker_king_music_phase_1] run playsound ancient_artifacts:music.shulker_king.loop record @s ~ ~ ~ 0.50 1
