...
##Update bossbar
execute if score .10 slow_tick matches 3 run function ancient_artifacts:shulker_castle/bossfight/bossbar/update
...
##Remove occupied
execute if score .60 slow_tick matches 60 as @e[tag=occupied] at @s unless entity @e[type=shulker,distance=..5,tag=!bounce_pad_hitbox] run tag @s remove occupied
