...
#the offer
execute if score .3 slow_tick matches 3 as @e[type=interaction,tag=shulker_king_offer] at @s run function ancient_artifacts:shulker_castle/intro/offer
...
execute as @e[type=item_display,tag=ring_small] at @s if score .5 slow_tick matches 5 run function ancient_artifacts:shulker_castle/intro/particles/ring_small

##Bossfight
function ancient_artifacts:shulker_castle/bossfight/tick

##Fix knockback_resistance
execute if score .10 slow_tick matches 3 as @a at @s run function ancient_artifacts:shulker_castle/bossfight/fix_knockback_resistance