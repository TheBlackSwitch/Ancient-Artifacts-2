...
summon shulker -56 59 -996 {Team:"aa.players",PersistenceRequired:1b,AttachFace:1b,Color:4b, \
    Tags:["shulker_king","INIT"],Invulnerable:1b,DeathLootTable:"minecraft:empty"}
