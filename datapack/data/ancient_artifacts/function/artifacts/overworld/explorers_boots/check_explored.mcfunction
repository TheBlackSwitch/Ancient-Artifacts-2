...
$execute positioned $(X) 320 $(Z) unless entity @e[type=marker,tag=explored_chunk,distance=..1] if score @s artifact matches 20..22 run scoreboard players add @s explored_chunks 1
$execute positioned $(X) 320 $(Z) unless entity @e[type=marker,tag=explored_chunk,distance=..1] if score @s artifact matches 20..22 run scoreboard players add @s total_explored_chunks 1
