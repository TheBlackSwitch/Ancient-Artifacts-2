...
execute rotated ~ 0 run summon firework_rocket ^ ^1 ^1 {LifeTime:0,FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{explosions:[{shape:"small_ball",has_trail:true,colors:[I;16772608],fade_colors:[I;16757012]}]}}}}
