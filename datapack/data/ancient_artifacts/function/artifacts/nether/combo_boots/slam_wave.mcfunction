...
execute as @e[tag=combo_knockback,tag=INIT,limit=1] run data modify entity @s Owner set from entity @p[predicate=theblackswitch:matches_search_id]
...
execute if score @s slam_distance matches ..6 run function ancient_artifacts:utilities/damage_entity_by_player_mainhand {"multiplier":1.1,"entities":"@e[distance=0.1..3,type=!#ancient_artifacts:no_damage,tag=!no_damage,tag=!tamed]"}
execute if score @s slam_distance matches 7..10 run function ancient_artifacts:utilities/damage_entity_by_player_mainhand {"multiplier":1.1,"entities":"@e[distance=0.1..4,type=!#ancient_artifacts:no_damage,tag=!no_damage,tag=!tamed]"}
execute if score @s slam_distance matches 11..14 run function ancient_artifacts:utilities/damage_entity_by_player_mainhand {"multiplier":1.1,"entities":"@e[distance=0.1..5,type=!#ancient_artifacts:no_damage,tag=!no_damage,tag=!tamed]"}
execute if score @s slam_distance matches 15..18 run function ancient_artifacts:utilities/damage_entity_by_player_mainhand {"multiplier":1.1,"entities":"@e[distance=0.1..6,type=!#ancient_artifacts:no_damage,tag=!no_damage,tag=!tamed]"}
execute if score @s slam_distance matches 19.. run function ancient_artifacts:utilities/damage_entity_by_player_mainhand {"multiplier":1.1,"entities":"@e[distance=0.1..7,type=!#ancient_artifacts:no_damage,tag=!no_damage,tag=!tamed]"}
