...
execute as @a[tag=slam] at @s if block ~ ~-1 ~ air run particle dust{color:[1.0, 1.0, 1.0],scale:4} ~ ~ ~ 0.1 0.3 0.1 0 5 force
...
tag @a[tag=slam,predicate=!theblackswitch:movement/sneak] remove slam
