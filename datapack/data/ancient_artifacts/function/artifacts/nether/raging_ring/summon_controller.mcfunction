...
summon polar_bear ~ ~ ~ {Tags:[rage_controller],attributes:[{id:"minecraft:scale",base:0.01}],Silent:1b,active_effects:[{id:"minecraft:invisibility",duration:-1,show_particles:false}],DeathLootTable:"minecraft:empty"}
