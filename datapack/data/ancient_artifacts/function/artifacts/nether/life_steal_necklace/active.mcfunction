...
execute if score @s attack matches 1.. if score @s artifact matches 73 run scoreboard players set .2 temp 2
...
execute if score @s attack matches 1.. if score @s artifact matches 74 run scoreboard players set .2 temp 4
...
execute if score @s attack matches 1.. if score @s artifact matches 75 run scoreboard players set .2 temp 6
...
execute if score @s attack matches 1.. if score @s artifact matches 76 run scoreboard players set .2 temp 8
