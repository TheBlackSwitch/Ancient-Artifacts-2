...
execute if score @s attract_time matches 120.. as @a[predicate=theblackswitch:matches_search_id] run advancement grant @s only ancient_artifacts:artifacts/end/attractive_expert
