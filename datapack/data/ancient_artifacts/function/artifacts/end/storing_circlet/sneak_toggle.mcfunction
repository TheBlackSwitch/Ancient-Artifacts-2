...
execute if score @s extra_inv_open matches 0 if score @s storing_circlet_particles matches 1 run particle minecraft:dust{color:[0.8,0.3,1.0],scale:1} ^ ^0.5 ^0.2 0.3 0.5 0.3 1 100
