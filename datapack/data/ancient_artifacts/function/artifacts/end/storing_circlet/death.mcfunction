...
execute if entity @s[scores={extra_inv_open=0}] run function theblackswitch:player_storage/insert with storage ancient_artifacts:temp player_storage
...
execute if entity @s[scores={extra_inv_open=1}] run function theblackswitch:player_storage/insert with storage ancient_artifacts:temp player_storage
