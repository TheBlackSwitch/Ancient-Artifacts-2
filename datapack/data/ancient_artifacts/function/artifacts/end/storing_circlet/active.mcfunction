...
execute if score @s sneak matches 1.. run scoreboard players set .sneak temp 1
...
execute if score .40 slow_tick matches 40 if score @s extra_inv_open matches 1 run function ancient_artifacts:artifacts/end/storing_circlet/check_expert
