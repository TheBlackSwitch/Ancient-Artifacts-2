summon bogged ~ ~-2 ~ {Tags:["necromanced","entity","INIT","tamed"],DeathLootTable:"minecraft:empty",equipment:{head:{id:"minecraft:gunpowder",count:1,components:{"minecraft:item_model":"ancient_artifacts:entity/sculk_mob"}},mainhand:{id:"bow",components:{unbreakable:{}}}},drop_chances:{head:0,mainhand:0}, \
    active_effects:[ \
