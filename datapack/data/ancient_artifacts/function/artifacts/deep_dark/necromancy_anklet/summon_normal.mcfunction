summon zombie ~ ~-2 ~ {Tags:["necromanced","entity","INIT","tamed"],DeathLootTable:"minecraft:empty",equipment:{head:{id:"minecraft:gunpowder",count:1,components:{"minecraft:item_model":"ancient_artifacts:entity/sculk_mob"}}},drop_chances:{head:0}, \
    active_effects:[ \
