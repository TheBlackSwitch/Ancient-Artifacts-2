...
summon minecraft:text_display ~0.5 ~0.2 ~0.5 {Rotation:[0f,-90f],Tags:["artifact_cauldron","fluid"],background:0,teleport_duration:3,text:{"text":"\uE801","color":"blue"},alignment:"center"}
