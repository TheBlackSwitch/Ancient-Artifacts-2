...
##Multiply by 100
scoreboard players operation .loot_chance temp *= .100 const
scoreboard players operation .common_chance temp *= .100 const
scoreboard players operation .uncommon_chance temp *= .100 const
scoreboard players operation .rare_chance temp *= .100 const
scoreboard players operation .unique_chance temp *= .100 const
