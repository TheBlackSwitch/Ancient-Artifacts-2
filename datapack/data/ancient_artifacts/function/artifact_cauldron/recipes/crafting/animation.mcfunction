...
execute if score .3 slow_tick matches 2 if score @s animation matches 40..90 at @s positioned ~ ~-0.5 ~ run function ancient_artifacts:artifact_cauldron/recipes/crafting/particle

execute if score @s animation matches 13..80 run particle dust{color:[1.0, 0.0, 1.0],scale:2} ~0.5 ~0.5 ~0.5 0.2 0.2 0.2 0 1 force
execute if score @s animation matches 13..70 run particle dust{color:[1.0, 0.0, 1.0],scale:2} ~0.5 ~0.5 ~0.5 0.2 0.2 0.2 0 1 force
execute if score @s animation matches 13..60 run particle dust{color:[1.0, 0.0, 1.0],scale:2} ~0.5 ~0.5 ~0.5 0.3 0.3 0.3 0 1 force
execute if score @s animation matches 13..33 run particle dust{color:[0.616, 0.0, 1.0],scale:2} ~0.5 ~0.5 ~0.5 0.4 0 0.4 0 10 force
execute if score @s animation matches 1..12 run particle dust{color:[0.984, 0.455, 0.871],scale:2} ~0.5 ~0.5 ~0.5 0.3 0.3 0.3 0 10 force
