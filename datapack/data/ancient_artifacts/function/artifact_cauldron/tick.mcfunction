...
execute if score .3 slow_tick matches 3 as @e[tag=artifact_cauldron_place] at @s align xyz run function ancient_artifacts:artifact_cauldron/place
...
execute if score .3 slow_tick = .3 random_delay at @e[tag=crafted] run particle end_rod ~ ~0.3 ~ 0 0 0 0.1 3 force
