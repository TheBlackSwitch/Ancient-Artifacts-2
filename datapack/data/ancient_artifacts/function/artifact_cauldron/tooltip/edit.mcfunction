...
execute if score @s current_recipe matches 0 align xyz run data modify entity @n[type=text_display,dy=0,tag=artifact_cauldron,tag=tooltip,tag=text] text set value [ \
    ...
    {"text":"  +3 ","color":"dark_purple","bold":false},{"text":"\uE840","color":"white","bold":false},{"text":" Water Bottle\n","color":"dark_purple","bold":false},  \
    {"text":"        "},{"text":"OR\n","color":"dark_green","bold":true,"underlined":true},  \
    {"text":"  +1 ","color":"dark_purple","bold":false},{"text":"\uE841","color":"white","bold":false},{"text":" Water Bucket\n","color":"dark_purple","bold":false}  \
]
...
execute if score @s current_recipe matches 1 align xyz run data modify entity @n[type=text_display,dy=0,tag=artifact_cauldron,tag=tooltip,tag=text] text set value [  \
    ...
    {"text":"Ancient Artifacts\n\n","color":"blue","font":"tooltip_namespace","bold":false},  \
    {"text":"Next: \n\n","color":"dark_green","bold":false,"font":"tooltip_namespace"},  \
    {"text":"  +2 ","color":"dark_purple","bold":false},{"text":"\uE842","color":"white","bold":false},{"text":" Artifact Blend\n","color":"dark_purple","bold":false},  \
    {"text":"    --> Recycle Blend\n","color":"#600060","bold":false},  \
    {"text":"        "},{"text":"OR\n","color":"dark_green","bold":true,"underlined":true},  \
    {"text":"  +1 ","color":"dark_purple","bold":false},{"text":"\uE843","color":"white","bold":false},{"text":"Common Artifact Template\n","color":"gray","bold":false},  \
    {"text":"    --> Craft A Common Artifact\n","color":"#600060","bold":false},  \
    {"text":"  +1 ","color":"dark_purple","bold":false},{"text":"\uE844","color":"white","bold":false},{"text":"Uncommon Artifact Template\n","color":"blue","bold":false},  \
    {"text":"    --> Craft An Uncommon Artifact\n","color":"#600060","bold":false},  \
    {"text":"  +1 ","color":"dark_purple","bold":false},{"text":"\uE845","color":"white","bold":false},{"text":"Rare Artifact Template\n","color":"light_purple","bold":false},  \
    {"text":"    --> Craft A Rare Artifact\n","color":"#600060","bold":false},  \
    {"text":"  +1 ","color":"dark_purple","bold":false},{"text":"\uE846","color":"white","bold":false},{"text":"Unique Artifact Template\n","color":"gold","bold":false},  \
...
execute if score @s current_recipe matches 10 align xyz run data modify entity @n[type=text_display,dy=0,tag=artifact_cauldron,tag=tooltip,tag=text] text set value [  \
    ...
    {"text":"Next: \n\n","color":"dark_green","bold":false,"font":"tooltip_namespace"},  \
    {"text":"  +1 ","color":"dark_purple","bold":false},{"text":"\uE842","color":"white","bold":false},{"text":" Artifact Blend","color":"dark_purple","bold":false}  \
]
...
execute if score @s current_recipe matches 11..15 if score .40 slow_tick matches 0..10 align xyz run data modify entity @n[type=text_display,dy=0,tag=artifact_cauldron,tag=tooltip,tag=text] text set value [  \
    ...
    {"text":"Next: \n\n","color":"dark_green","bold":false,"font":"tooltip_namespace"},  \
    {"text":"  +1 ","color":"dark_purple","bold":false},{"text":"\uE842","color":"white","bold":false},{"text":" Artifact Blend\n","color":"dark_purple","bold":false},  \
    {"text":"    --> Craft Artifact\n","color":"#600060","bold":false},  \
    {"text":"        "},{"text":"OR\n","color":"dark_green","bold":true,"underlined":true},  \
    {"text":"  +1 ","color":"dark_purple","bold":false},{"text":"\uE847","color":"white","bold":false},{"text":" Any Essence\n","color":"dark_purple","bold":false},  \
...
execute if score @s current_recipe matches 20 align xyz run data modify entity @n[type=text_display,dy=0,tag=artifact_cauldron,tag=tooltip,tag=text] text set value [  \
    ...
    {"text":"Next: \n\n","color":"dark_green","bold":false,"font":"tooltip_namespace"},  \
    {"text":"  +1 ","color":"dark_purple","bold":false},{"text":"\uE851","color":"white","bold":false},{"text":" Amethyst Shard\n","color":"dark_purple","bold":false},  \
    {"text":"    --> Overworld Artifact\n","color":"#600060","bold":false},  \
    {"text":"  +1 ","color":"dark_purple","bold":false},{"text":"\uE852","color":"white","bold":false},{"text":" Quartz Compound\n","color":"dark_purple","bold":false},  \
    {"text":"    --> Nether Artifact\n","color":"#600060","bold":false},  \
    {"text":"  +1 ","color":"dark_purple","bold":false},{"text":"\uE853","color":"white","bold":false},{"text":" Chorus Compound\n","color":"dark_purple","bold":false},  \
    {"text":"    --> End Artifact\n","color":"#600060","bold":false},  \
    {"text":"  +1 ","color":"dark_purple","bold":false},{"text":"\uE854","color":"white","bold":false},{"text":" Echoing Compound\n","color":"dark_purple","bold":false},  \
