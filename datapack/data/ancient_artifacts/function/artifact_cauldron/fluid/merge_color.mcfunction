...
execute align xyz run scoreboard players operation @n[type=text_display,tag=fluid,dy=0] R /= .2 const
execute align xyz run scoreboard players operation @n[type=text_display,tag=fluid,dy=0] G /= .2 const
execute align xyz run scoreboard players operation @n[type=text_display,tag=fluid,dy=0] B /= .2 const
