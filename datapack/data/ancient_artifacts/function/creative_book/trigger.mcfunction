...
execute unless entity @s[gamemode=creative] run return run scoreboard players reset @s aa.creative_book

execute if predicate ancient_artifacts:is_on_designer_plot run playsound block.note_block.didgeridoo master @s ~ ~ ~ 1 0.7
execute if predicate ancient_artifacts:is_on_designer_plot run tellraw @s [{"text":"[Ancient Artifacts]: ","color":"light_purple"},{"text":"You can't use that on here!","color":"red"}]
execute if predicate ancient_artifacts:is_on_designer_plot run return run scoreboard players reset @s aa.creative_book

execute if score @s aa.creative_book matches 1..4560000 run tellraw @s [{"text":"[Ancient Artifacts]: ","color":"light_purple"},{"text":"Successfully gave you a creative book!","color":"green"}]
execute if score @s aa.creative_book matches 1..4560000 run loot give @s loot ancient_artifacts:item/creative_book
execute if score @s aa.creative_book matches 1..4560000 run return run scoreboard players reset @s aa.creative_book
...
scoreboard players reset @a aa.creative_book