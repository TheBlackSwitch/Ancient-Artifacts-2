...
execute if score .3 slow_tick matches 3 as @a[scores={used_artifact=1..},predicate=ancient_artifacts:holding_artifact] run function ancient_artifacts:artifact_hotbar/activate
execute if score .3 slow_tick matches 3 run scoreboard players set @a used_artifact 0
