...
##Artifact Bar Icon
execute if score @s[tag=!focused] artifact_slot_count matches 2 run summon marker ~ ~ ~ {CustomName:{"text":"\uE500\uF801\uF803  "},Tags:[artifact_hotbar,order_1]}
execute if score @s[tag=!focused] artifact_slot_count matches 3 run summon marker ~ ~ ~ {CustomName:{"text":"\uE501\uF801"},Tags:[artifact_hotbar,order_1]}
...
##Artifact Slot 1
summon marker ~ ~ ~ {CustomName:{"text":"\uE700  "},Tags:[artifact_hotbar,order_2,ah_INIT]}
...
##Artifact Slot 2
summon marker ~ ~ ~ {CustomName:{"text":"\uE700  "},Tags:[artifact_hotbar,order_4,ah_INIT]}
...
execute if score @s artifact_slot_count matches 3 run summon marker ~ ~ ~ {CustomName:{"text":"\uE700  "},Tags:[artifact_hotbar,order_5,ah_INIT]}
...
##End Spacing
execute if score @s artifact_slot_count matches 2 run summon marker ~ ~ ~ {CustomName:{"text":"   \uF802"},Tags:[artifact_hotbar,order_6]}
execute if score @s artifact_slot_count matches 3 run summon marker ~ ~ ~ {CustomName:{"text":" \uF802"},Tags:[artifact_hotbar,order_6]}

##combine parts
title @s actionbar [{"type":"selector","selector":"@e[type=marker,tag=artifact_hotbar,tag=order_1,distance=..1]","color":"#4e5c24"},{"type":"selector","selector":"@e[type=marker,tag=artifact_hotbar,tag=order_2,distance=..1]"}   ,{"type":"selector","selector":"@e[type=marker,tag=artifact_hotbar,tag=order_3,distance=..1]"}    ,{"type":"selector","selector":"@e[type=marker,tag=artifact_hotbar,tag=order_4,distance=..1]"}    ,{"type":"selector","selector":"@e[type=marker,tag=artifact_hotbar,tag=order_5,distance=..1]"} ,{"type":"selector","selector":"@e[type=marker,tag=artifact_hotbar,tag=order_6,distance=..1]"}]
