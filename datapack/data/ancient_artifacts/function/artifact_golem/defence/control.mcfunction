...
execute if data entity @s attack on attacker run damage @s 2 ancient_artifacts:artifact_golem_thorns by @e[tag=artifact_golem,tag=center,limit=1,sort=nearest]
