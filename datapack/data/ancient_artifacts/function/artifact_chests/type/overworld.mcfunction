...
#holding amethyst
execute if data entity @s[tag=!opened] interaction unless score @s animation matches 1.. on target if items entity @s weapon.mainhand amethyst_shard[!custom_data] unless data entity @s SelectedItem.components run function ancient_artifacts:advancements/triggers/open_overworld_chest
execute if data entity @s[tag=!opened] interaction unless score @s animation matches 1.. on target if items entity @s weapon.mainhand amethyst_shard[!custom_data] unless data entity @s SelectedItem.components as @e[type=interaction,limit=1,sort=nearest,tag=!opened] run scoreboard players set @s animation 30
