...
execute if data entity @s[tag=!opened] interaction on target unless entity @s[nbt={SelectedItem:{id:"minecraft:amethyst_shard"}}] run data modify storage smithed.actionbar:input message set value {json:{"text": "It seems like an amethyst shard is needed...","color": "light_purple"},priority:"notification"}
execute if data entity @s[tag=!opened] interaction on target unless entity @s[nbt={SelectedItem:{id:"minecraft:amethyst_shard"}}] run function #smithed.actionbar:message
...
execute if data entity @s[tag=!opened] interaction on target if data entity @s SelectedItem.components run data modify storage smithed.actionbar:input message set value {json:{"text": "It seems like an amethyst shard is needed...","color": "light_purple"},priority:"notification"}
execute if data entity @s[tag=!opened] interaction on target if data entity @s SelectedItem.components run function #smithed.actionbar:message
...
#holding amethyst
execute if data entity @s[tag=!opened] interaction unless score @s animation matches 1.. on target if entity @s[nbt={SelectedItem:{id:"minecraft:amethyst_shard"}}] unless data entity @s SelectedItem.components as @e[type=interaction,limit=1,sort=nearest,tag=!opened] run scoreboard players add @s amethyst_count 1

##Amethyst insert
execute if data entity @s[tag=!opened] interaction if score @s amethyst_count matches 1 on target if entity @s[nbt={SelectedItem:{id:"minecraft:amethyst_shard"}}] unless data entity @s SelectedItem.components as @e[type=interaction,limit=1,sort=nearest,tag=!opened] run particle minecraft:dust{color:[1.0,0.0,1.0],scale:1} ~ ~ ~ 0.3 0.3 0.3 1 15 force
execute if data entity @s[tag=!opened] interaction if score @s amethyst_count matches 1 on target if entity @s[nbt={SelectedItem:{id:"minecraft:amethyst_shard"}}] unless data entity @s SelectedItem.components as @e[type=interaction,limit=1,sort=nearest,tag=!opened] run item modify entity @e[type=item_display,tag=artifact_chest,sort=nearest,limit=1] container.0 {function:"set_custom_model_data",strings:{mode:"replace_all",values:["active_1"]}}
execute if data entity @s[tag=!opened] interaction if score @s amethyst_count matches 1 on target if entity @s[nbt={SelectedItem:{id:"minecraft:amethyst_shard"}}] unless data entity @s SelectedItem.components as @e[type=interaction,limit=1,sort=nearest,tag=!opened] run playsound entity.ender_eye.death block @a ~ ~ ~ 1 1.6
execute if data entity @s[tag=!opened] interaction if score @s amethyst_count matches 1 on target if entity @s[nbt={SelectedItem:{id:"minecraft:amethyst_shard"}}] unless data entity @s SelectedItem.components as @e[type=interaction,limit=1,sort=nearest,tag=!opened] on target if predicate ancient_artifacts:survival run clear @s amethyst_shard[!minecraft:custom_data] 1

execute if data entity @s[tag=!opened] interaction if score @s amethyst_count matches 2 on target if entity @s[nbt={SelectedItem:{id:"minecraft:amethyst_shard"}}] unless data entity @s SelectedItem.components as @e[type=interaction,limit=1,sort=nearest,tag=!opened] run particle minecraft:dust{color:[1.0,0.0,1.0],scale:2} ~ ~ ~ 0.3 0.3 0.3 1 15 force
...
execute if data entity @s[tag=!opened] interaction if score @s amethyst_count matches 2 on target if entity @s[nbt={SelectedItem:{id:"minecraft:amethyst_shard"}}] unless data entity @s SelectedItem.components as @e[type=interaction,limit=1,sort=nearest,tag=!opened] run playsound entity.ender_eye.death block @a ~ ~ ~ 1 1.7
execute if data entity @s[tag=!opened] interaction if score @s amethyst_count matches 2 on target if entity @s[nbt={SelectedItem:{id:"minecraft:amethyst_shard"}}] unless data entity @s SelectedItem.components as @e[type=interaction,limit=1,sort=nearest,tag=!opened] on target if predicate ancient_artifacts:survival run clear @s amethyst_shard[!minecraft:custom_data] 1
