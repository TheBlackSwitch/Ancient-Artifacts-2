...
execute if data entity @s[tag=!opened] interaction on target unless items entity @s weapon.mainhand *[custom_data~{compound:1b, type:"end"}] run playsound minecraft:block.amethyst_block.hit block @a ~ ~ ~ 1 2
execute if data entity @s[tag=!opened] interaction on target unless items entity @s weapon.mainhand *[custom_data~{compound:1b, type:"end"}] run data modify storage smithed.actionbar:input message set value {json:{"text": "It seems like a chorus compound is needed...","color": "light_purple"},priority:"notification"}
execute if data entity @s[tag=!opened] interaction on target unless items entity @s weapon.mainhand *[custom_data~{compound:1b, type:"end"}] run function #smithed.actionbar:message
execute if data entity @s[tag=!opened] interaction on target unless items entity @s weapon.mainhand *[custom_data~{compound:1b, type:"end"}] positioned ~ ~-0.5 ~ run data remove entity @n[type=interaction,tag=artifact_chest,tag=end] interaction
#holding chorus compound
execute if data entity @s[tag=!opened] interaction on target if items entity @s weapon.mainhand *[custom_data~{compound:1b, type:"end"}] run function ancient_artifacts:advancements/triggers/open_end_chest
execute if data entity @s[tag=!opened] interaction on target if items entity @s weapon.mainhand *[custom_data~{compound:1b, type:"end"}] run scoreboard players set @n[type=interaction,tag=!opened] animation 60
...
execute if score @s animation matches 60 on target if predicate ancient_artifacts:survival run clear @s *[minecraft:custom_data={compound:1b,type:"end"}] 1
