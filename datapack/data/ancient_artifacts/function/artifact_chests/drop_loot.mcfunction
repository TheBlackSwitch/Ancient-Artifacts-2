...
execute align xyz if entity @e[y_rotation=90,type=item_display,dy=0] run data modify storage ancient_artifacts:item_motion X set value -0.1d
execute align xyz if entity @e[y_rotation=0,type=item_display,dy=0] run data modify storage ancient_artifacts:item_motion Z set value 0.1d
execute align xyz if entity @e[y_rotation=-90,type=item_display,dy=0] run data modify storage ancient_artifacts:item_motion X set value 0.1d
execute align xyz if entity @e[y_rotation=180,type=item_display,dy=0] run data modify storage ancient_artifacts:item_motion Z set value -0.1d
...
$execute as @s run loot replace entity @n[type=chest_minecart,tag=temp_loot] container.0 loot $(loot_table)
