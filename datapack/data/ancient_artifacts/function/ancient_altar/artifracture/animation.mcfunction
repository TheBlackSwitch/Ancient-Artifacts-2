...
execute if score @s animation matches 50..100 if score .10 slow_tick = .10 random_delay run playsound block.respawn_anchor.deplete block @a ~ ~ ~ 1 2
execute if score @s animation matches 50..100 if score .10 slow_tick = .10 random_delay run particle firework ~ ~0.5 ~ 0 0 0 0.3 10 force
execute if score @s animation matches 50..100 if score .10 slow_tick = .10 random_delay run playsound entity.lightning_bolt.impact master @a ~ ~ ~ 0.5 0
execute if score @s animation matches 50..100 if score .10 slow_tick = .10 random_delay run playsound entity.lightning_bolt.thunder master @a ~ ~ ~ 0.5 1
execute if score @s animation matches 50..100 if score .10 slow_tick = .10 random_delay run function ancient_artifacts:ancient_altar/summon_bolt
