...
execute if score @s artifact matches 28 if predicate theblackswitch:v2.0/patch-4/movement_check/sneak if items entity @s weapon.mainhand #pickaxes run attribute @s block_break_speed modifier add miners_crown -0.75 add_multiplied_total
execute if score @s artifact matches 29.. run tag @s add mine_9
execute if score @s artifact matches 29.. if predicate theblackswitch:v2.0/patch-4/movement_check/sneak if items entity @s weapon.mainhand #pickaxes run attribute @s block_break_speed modifier add miners_crown -0.88 add_multiplied_total
