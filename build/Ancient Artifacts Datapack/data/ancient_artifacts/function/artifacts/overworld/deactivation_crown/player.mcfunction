...
execute if entity @s[tag=!deact_effects, tag=deactivated] run particle minecraft:dust{color: [1.0d, 0.4d, 0.4d], scale: 3} ~ ~0.75 ~ 0.8 0 0 0 20
execute if entity @s[tag=!deact_effects, tag=deactivated] run particle minecraft:dust{color: [1.0d, 0.4d, 0.4d], scale: 3} ~ ~0.75 ~ 0 0 0.8 0 20
...
execute if entity @s[tag=deact_effects, tag=!deactivated] run particle minecraft:dust{color: [0.4d, 0.612d, 1.0d], scale: 3} ~ ~0.75 ~ 0.8 0 0 0 20
execute if entity @s[tag=deact_effects, tag=!deactivated] run particle minecraft:dust{color: [0.4d, 0.612d, 1.0d], scale: 3} ~ ~0.75 ~ 0 0 0.8 0 20
execute if entity @s[tag=deact_effects, tag=!deactivated] run function ancient_artifacts:artifacts/overworld/deactivation_crown/deactivate
execute if entity @s[tag=deact_effects, tag=!deactivated] run function ancient_artifacts:artifact_hotbar/show
