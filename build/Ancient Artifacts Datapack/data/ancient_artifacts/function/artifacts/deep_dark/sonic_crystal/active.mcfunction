...
execute if predicate theblackswitch:v2.0/patch-3/movement_check/sneak unless score @s sonic_cooldown matches 1.. run scoreboard players set @s sonic_cooldown 2440
execute unless predicate theblackswitch:v2.0/patch-3/movement_check/sneak if score @s sonic_cooldown matches 2401..2440 run function ancient_artifacts:artifacts/deep_dark/sonic_crystal/reset
