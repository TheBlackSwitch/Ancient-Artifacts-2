...
execute as @e[distance=..3, tag=!tamed, type=!#ancient_artifacts:no_damage, tag=!smithed.strict, predicate=!theblackswitch:v2.0/patch-2/player_id/match_search] run damage @s 10 sonic_boom by @a[predicate=theblackswitch:v2.0/patch-2/player_id/match_search, limit=1]
