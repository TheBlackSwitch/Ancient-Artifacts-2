...
execute if predicate theblackswitch:v2.0/patch-3/movement_check/sneak if score @s artifact matches 117 if predicate ancient_artifacts:holding_tool run attribute @s block_break_speed modifier add bulky_chain -0.88 add_multiplied_total
execute if predicate theblackswitch:v2.0/patch-3/movement_check/sneak if score @s artifact matches 118.. if predicate ancient_artifacts:holding_tool run attribute @s block_break_speed modifier add bulky_chain -0.92 add_multiplied_total
