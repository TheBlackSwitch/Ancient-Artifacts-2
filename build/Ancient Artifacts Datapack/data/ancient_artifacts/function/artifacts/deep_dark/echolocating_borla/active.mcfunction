...
execute if score @s artifact matches 96 if score #40 tbs.slow_tick matches 40 run effect give @e[type=!#ancient_artifacts:non_living, type=!#ancient_artifacts:no_damage, predicate=!theblackswitch:v2.0/patch-2/player_id/match_search, distance=..20, tag=!no_glow, tag=!smithed.strict] glowing 3 0 true
execute if score @s artifact matches 97 if score #40 tbs.slow_tick matches 40 run effect give @e[type=!#ancient_artifacts:non_living, type=!#ancient_artifacts:no_damage, predicate=!theblackswitch:v2.0/patch-2/player_id/match_search, distance=..25, tag=!no_glow, tag=!smithed.strict] glowing 3 0 true
execute if score @s artifact matches 98 if score #40 tbs.slow_tick matches 40 run effect give @e[type=!#ancient_artifacts:non_living, type=!#ancient_artifacts:no_damage, predicate=!theblackswitch:v2.0/patch-2/player_id/match_search, distance=..30, tag=!no_glow, tag=!smithed.strict] glowing 3 0 true
execute if score @s artifact matches 99 if score #40 tbs.slow_tick matches 40 run effect give @e[type=!#ancient_artifacts:non_living, type=!#ancient_artifacts:no_damage, predicate=!theblackswitch:v2.0/patch-2/player_id/match_search, distance=..35, tag=!no_glow, tag=!smithed.strict] glowing 3 0 true
execute if score @s artifact matches 100 if score #40 tbs.slow_tick matches 40 run effect give @e[type=!#ancient_artifacts:non_living, type=!#ancient_artifacts:no_damage, predicate=!theblackswitch:v2.0/patch-2/player_id/match_search, distance=..50, tag=!no_glow, tag=!smithed.strict] glowing 3 0 true
