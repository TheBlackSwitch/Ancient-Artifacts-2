...
execute as @e[tag=!tamed, type=!#ancient_artifacts:no_damage, tag=!smithed.strict, distance=..3, predicate=!theblackswitch:v2.0/patch-2/player_id/match_search] run function ancient_artifacts:utilities/damage_entity_by_search {damage: 5}
