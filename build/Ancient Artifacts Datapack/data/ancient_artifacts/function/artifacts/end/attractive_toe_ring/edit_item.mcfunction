...
execute if score @s attract_time matches 120.. as @a[predicate=theblackswitch:v2.0/patch-2/player_id/match_search] run advancement grant @s only ancient_artifacts:artifacts/end/attractive_expert
