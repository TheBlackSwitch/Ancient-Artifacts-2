...
execute if score @s artifact matches 123 run attribute @s gravity modifier add gravitation_toe_ring -0.5 add_multiplied_total
...
execute if score @s artifact matches 122 run attribute @s safe_fall_distance modifier add gravitation_toe_ring 0.5 add_multiplied_total
