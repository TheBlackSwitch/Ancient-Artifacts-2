tag @s add deflected
$execute if predicate theblackswitch:v2.0/patch-3/rand/$(chance) run return fail
...
scoreboard players add @a[predicate=theblackswitch:v2.0/patch-3/player_id/match_search] deflected 1
