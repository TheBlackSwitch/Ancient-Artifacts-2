tag @s add deflected
$execute if predicate theblackswitch:v2.0/patch-1/rand/$(chance) run return fail
...
scoreboard players add @a[predicate=theblackswitch:v2.0/patch-1/player_id/match_search] deflected 1
