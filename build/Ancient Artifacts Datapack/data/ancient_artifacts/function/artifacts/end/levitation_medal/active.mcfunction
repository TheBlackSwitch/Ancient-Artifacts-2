...
execute if score @s artifact matches 133..136 if predicate theblackswitch:v2.0/patch-4/movement_check/sneak if score @s levitation_power matches 1.. run effect give @s levitation 1 2
execute if score @s artifact matches 137 if predicate theblackswitch:v2.0/patch-4/movement_check/sneak if score @s levitation_power matches 1.. run effect give @s levitation 1 5
execute if score @s artifact matches 138 if predicate theblackswitch:v2.0/patch-4/movement_check/sneak if score @s levitation_power matches 1.. run effect give @s levitation 1 8
execute if predicate theblackswitch:v2.0/patch-4/movement_check/sneak if score @s levitation_power matches 1.. run scoreboard players remove @s levitation_power 1
execute unless predicate theblackswitch:v2.0/patch-4/movement_check/sneak run effect clear @s levitation
execute if predicate theblackswitch:v2.0/patch-4/movement_check/sneak if score @s levitation_power matches 1.. run scoreboard players add @s levitate_ticks 1
