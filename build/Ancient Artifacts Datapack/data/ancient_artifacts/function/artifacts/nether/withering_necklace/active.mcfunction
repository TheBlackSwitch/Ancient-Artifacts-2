...
execute if score #3 tbs.slow_tick matches 3 if predicate theblackswitch:v2.0/patch-4/movement_check/sneak run particle minecraft:dust{color: [0.2d, 0.1d, 0.1d], scale: 4} ~ ~ ~ 0.2 0 0.2 0 1
...
execute if predicate theblackswitch:v2.0/patch-4/movement_check/sneak if score .1 temp matches 30.. run advancement grant @s only ancient_artifacts:artifacts/nether/withering_expert
