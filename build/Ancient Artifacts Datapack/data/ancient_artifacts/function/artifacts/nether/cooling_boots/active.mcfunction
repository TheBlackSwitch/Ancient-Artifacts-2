...
execute if score @s artifact matches 67 if predicate theblackswitch:v2.0/patch-3/movement_check/sprint unless block ~ ~ ~ lava run function ancient_artifacts:artifacts/nether/cooling_boots/fill/scale_1
execute if score @s artifact matches 68 if predicate theblackswitch:v2.0/patch-3/movement_check/sprint unless block ~ ~ ~ lava run function ancient_artifacts:artifacts/nether/cooling_boots/fill/scale_2
execute if score @s artifact matches 69 if predicate theblackswitch:v2.0/patch-3/movement_check/sprint unless block ~ ~ ~ lava run function ancient_artifacts:artifacts/nether/cooling_boots/fill/scale_3
