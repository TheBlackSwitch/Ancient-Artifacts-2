...
execute if entity @e[type=ghast, distance=..10] run scoreboard players add @a[predicate=theblackswitch:v2.0/patch-3/player_id/match_search, limit=1] ghasts_fireballed 1
