...
execute as @e[tag=!tamed, type=!#ancient_artifacts:no_damage, tag=!smithed.strict, predicate=!theblackswitch:v2.0/patch-4/player_id/match_search, distance=..3] run function ancient_artifacts:utilities/damage_entity_by_search {damage: 3}
