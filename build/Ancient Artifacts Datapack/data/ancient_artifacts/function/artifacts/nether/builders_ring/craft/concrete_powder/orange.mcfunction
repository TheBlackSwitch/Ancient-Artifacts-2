advancement revoke @s only ancient_artifacts:cheap_recipe/concrete_powder/orange
...
execute if score @s random matches 1 run give @s orange_concrete_powder 8
