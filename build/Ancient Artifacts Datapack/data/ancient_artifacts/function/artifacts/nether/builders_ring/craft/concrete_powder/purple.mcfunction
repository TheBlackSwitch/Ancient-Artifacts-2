advancement revoke @s only ancient_artifacts:cheap_recipe/concrete_powder/purple
...
execute if score @s random matches 1 run give @s purple_concrete_powder 8
