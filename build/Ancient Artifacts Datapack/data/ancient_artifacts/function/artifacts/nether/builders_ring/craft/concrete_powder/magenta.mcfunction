advancement revoke @s only ancient_artifacts:cheap_recipe/concrete_powder/magenta
...
execute if score @s random matches 1 run give @s magenta_concrete_powder 8
