advancement revoke @s only ancient_artifacts:cheap_recipe/concrete_powder/yellow
...
execute if score @s random matches 1 run give @s yellow_concrete_powder 8
