advancement revoke @s only ancient_artifacts:cheap_recipe/concrete_powder/light_blue
...
execute if score @s random matches 1 run give @s light_blue_concrete_powder 8
