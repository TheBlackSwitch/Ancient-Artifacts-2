...
execute at @s store result score .raged_creepers temp if entity @e[scores={rage=1..}, type=creeper, distance=..50, predicate=theblackswitch:v2.0/patch-3/player_id/match_search]
