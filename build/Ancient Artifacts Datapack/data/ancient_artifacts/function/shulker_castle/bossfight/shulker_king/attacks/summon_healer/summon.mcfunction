...
summon shulker ~ ~ ~ {AttachFace: 0b, Color: 14b, Tags: ["healing_shulker", "INIT"], active_effects: [{id: "minecraft:regeneration", amplifier: 0, duration: -1}], attributes: [{id: "minecraft:max_health", base: 8}, {id: "minecraft:scale", base: 1.5d}]}
