...
execute if score @s animation matches 40 if predicate theblackswitch:v2.0/patch-1/rand/25 run function ancient_artifacts:shulker_castle/bossfight/shulker_king/attacks/summon_healer/summon
...
execute if score @s animation matches 140 if predicate theblackswitch:v2.0/patch-1/rand/25 run function ancient_artifacts:shulker_castle/bossfight/shulker_king/attacks/summon_healer/summon
