...
execute unless score @s tp_cooldown matches 1.. if entity @s[nbt={HurtTime: 10s}] if predicate theblackswitch:v2.0/patch-4/rand/65 run function ancient_artifacts:shulker_castle/bossfight/shulker_king/defence/teleport/activate
...
execute if score @s animation matches 20 if entity @s[tag=difficulty_1] if predicate theblackswitch:v2.0/patch-4/rand/25 if score @s attack matches 12..17 store result score @s attack run random value 0..29
execute if score @s animation matches 20 if entity @s[tag=difficulty_2] if predicate theblackswitch:v2.0/patch-4/rand/25 if score @s attack matches 12..17 store result score @s attack run random value 0..29
