...
execute unless score @s animation matches 1.. align xyz positioned ~-0.5 ~ ~-0.5 if entity @a[dx=1, dy=0, dz=1, predicate=!theblackswitch:v2.0/patch-4/movement_check/sneak] run function ancient_artifacts:shulker_castle/castle_platforms/bounce_pad/activate
