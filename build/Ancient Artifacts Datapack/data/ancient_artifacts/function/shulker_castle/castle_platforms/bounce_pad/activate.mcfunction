...
execute as @p[predicate=!theblackswitch:v2.0/patch-3/movement_check/sneak] at @s run function ancient_artifacts:shulker_castle/castle_platforms/bounce_pad/windcharge_launch
