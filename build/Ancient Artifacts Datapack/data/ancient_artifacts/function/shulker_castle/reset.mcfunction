...
execute at @n[tag=shulker_castle] run summon shulker ~ ~ ~ {Team: "aa.players", PersistenceRequired: 1b, AttachFace: 1b, Color: 4b, Tags: ["shulker_king", "INIT"], Invulnerable: 1b, DeathLootTable: "ancient_artifacts:empty"}
