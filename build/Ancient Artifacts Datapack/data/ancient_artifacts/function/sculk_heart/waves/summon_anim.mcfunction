...
execute if score @s lifetime matches ..0 run data merge entity @s {attributes: [{id: "scale", base: 0.001d}], active_effects: [{id: "invisibility", show_particles: false, duration: -1, amplifier: 1}], Invulnerable: 1b, NoAI: 1b, Silent: 1b}
