...
execute if entity @e[type=item_display, tag=sculk_heart, tag=center, scores={heart_state=2}, distance=..40] if score @s sculk_heart_music_timer matches ..-1000000 run scoreboard players set @s sculk_heart_music_timer 19070
