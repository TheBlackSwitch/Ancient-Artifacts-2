...
data modify storage smithed.actionbar:input message.json set value [{type: "selector", selector: "@e[type=marker,tag=artifact_hotbar,tag=order_1,distance=..1]", shadow_color: 0}, {type: "selector", selector: "@e[type=marker,tag=artifact_hotbar,tag=order_2,distance=..1]"}, {type: "selector", selector: "@e[type=marker,tag=artifact_hotbar,tag=order_3,distance=..1]"}, {type: "selector", selector: "@e[type=marker,tag=artifact_hotbar,tag=order_4,distance=..1]"}, {type: "selector", selector: "@e[type=marker,tag=artifact_hotbar,tag=order_5,distance=..1]"}, {type: "selector", selector: "@e[type=marker,tag=artifact_hotbar,tag=order_6,distance=..1]"}]
