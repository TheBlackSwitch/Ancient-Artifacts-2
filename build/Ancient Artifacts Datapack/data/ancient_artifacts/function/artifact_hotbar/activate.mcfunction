...
execute unless predicate theblackswitch:v2.0/patch-4/movement_check/sneak run function ancient_artifacts:artifact_hotbar/activate/nested_execute_0
...
execute unless predicate theblackswitch:v2.0/patch-4/movement_check/sneak run function ancient_artifacts:artifact_hotbar/activate/nested_execute_1
tag @e[type=item_display, tag=artifact_activate_particles] remove INIT
execute if predicate theblackswitch:v2.0/patch-4/movement_check/sneak run function ancient_artifacts:artifact_hotbar/activate/nested_execute_2
