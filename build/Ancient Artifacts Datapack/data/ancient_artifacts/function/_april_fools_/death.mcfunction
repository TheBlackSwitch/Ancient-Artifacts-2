...
execute if score #rand temp matches 0 run tellraw @a [{text: "[Ancient Intelligence]: ", color: "red"}, {text: "Damn are you that bad at the game? I shall assist you further"}]
