...
execute store success score #is_smith temp run function ancient_artifacts:artifact_smith/check_cauldron with storage ancient_artifacts:smith block
execute if score #is_smith temp matches 1 run function ancient_artifacts:artifact_smith/update_smith/nested_execute_0
tag @s add checked
tag @s remove reset
