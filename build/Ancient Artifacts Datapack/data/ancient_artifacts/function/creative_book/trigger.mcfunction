schedule function ancient_artifacts:creative_book/enable 1 append
execute unless entity @s[gamemode=creative] run return run function ancient_artifacts:creative_book/trigger/nested_return_0
execute if predicate ancient_artifacts:is_on_designer_plot run return run function ancient_artifacts:creative_book/trigger/nested_return_1
execute if score @s aa.creative_book matches 1..4560000 run return run function ancient_artifacts:creative_book/trigger/nested_return_2
