...
execute unless score @s smithed.actionbar.priority matches 1 if score $priority smithed.actionbar.temp <= @s smithed.actionbar.priority run function smithed.actionbar:v0.6.6/display
execute if score @s smithed.actionbar.priority matches 0 run function smithed.actionbar:v0.6.6/display
