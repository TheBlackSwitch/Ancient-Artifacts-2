schedule function smithed.actionbar:v0.7.0/technical/tick 1 replace
execute as @a[scores={smithed.actionbar.freeze=1}] run function smithed.actionbar:v0.7.0/reset
