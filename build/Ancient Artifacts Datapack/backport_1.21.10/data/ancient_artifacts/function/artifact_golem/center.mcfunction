...
execute if score #60 tbs.slow_tick matches 30 run function ancient_artifacts:artifact_golem/center/nested_execute_2
execute unless entity @s[tag=summoned] run function ancient_artifacts:artifact_golem/summon_animation
execute if entity @s[tag=summoned] run function ancient_artifacts:artifact_golem/center/nested_execute_3
