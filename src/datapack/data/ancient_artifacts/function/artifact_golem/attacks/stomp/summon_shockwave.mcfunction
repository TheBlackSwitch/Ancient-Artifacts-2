...
execute unless score @s shockwave_distance matches 121.. run summon item_display ~ ~ ~ {Tags:[ag_shockwave, INIT, smithed.entity, smithed.strict],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1000f,0.2f]},item:{id:"minecraft:glowstone_dust",count:1b,components:{"minecraft:item_model":"ancient_artifacts:misc/shockwave"}},view_range:2f,brightness:{sky:0,block:15},teleport_duration:6,interpolation_duration:6}
