...
execute if score @s animation matches 40 if predicate theblackswitch:__version__/__patch__/rand/25 run function ancient_artifacts:shulker_castle/bossfight/shulker_king/attacks/summon_healer/summon
...
execute if score @s animation matches 140 if predicate theblackswitch:__version__/__patch__/rand/25 run function ancient_artifacts:shulker_castle/bossfight/shulker_king/attacks/summon_healer/summon
