...
execute as @e[type=marker,tag=shulker_castle,tag=shulker_king_music_start,tag=!boss_finished] at @s run function ancient_artifacts:shulker_castle/bossfight/shulker_castle

##Check For Strong Bullet Detonation
...
##Shulker King Boss Music
execute if score #10 tbs.slow_tick matches 5 as @a[scores={shulker_king_music_timer=1..}] at @s unless entity @e[type=marker,tag=shulker_castle,distance=..63,tag=shulker_king_music_start,tag=!boss_finished] run tag @s remove shulker_king_music
execute if score #10 tbs.slow_tick matches 5 as @a[scores={shulker_king_music_timer=1..}] at @s unless entity @e[type=marker,tag=shulker_castle,distance=..63,tag=shulker_king_music_start,tag=!boss_finished] run function ancient_artifacts:shulker_castle/bossfight/song/reset
