...
#execute unless score @s checked matches 1 if score @s random matches 1..3 run say hall
...
#execute unless score @s checked matches 1 if score @s random matches 4..6 run say wall
...
#execute unless score @s checked matches 1 if score @s random matches 7..8 run say room
...
#execute unless score @s checked matches 1 if score @s random matches 9..10 run say hall
