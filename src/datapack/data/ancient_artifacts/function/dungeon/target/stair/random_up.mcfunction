...
$execute if score @s random matches 1 run place template dungeon:hall6 ~ ~ ~ $(rot)
#execute if score @s random matches 1 run say 6
$execute if score @s random matches 2 run place template dungeon:hall7 ~ ~ ~ $(rot)
#execute if score @s random matches 2 run say 7
$execute if score @s random matches 3..4 run place template dungeon:hall5 ~ ~ ~ $(rot)
#execute if score @s random matches 3..4 run say 5
