...
##Inits
execute if score #3 tbs.slow_tick matches 3 as @a at @s store success score @s fire if predicate ancient_artifacts:is_on_fire
...
execute if score #10 tbs.slow_tick matches 10 run function ancient_artifacts:artifacts/overworld/deactivation_crown/tick
...
execute if score #3 tbs.slow_tick matches 3 run function ancient_artifacts:artifacts/nether/fireball_ring/tick
