...
$execute positioned ~ ~ ~-1 if block ~ ~ ~ $(id) unless entity @e[tag=smithed.block,dy=0] positioned ~0.5 ~0.5 ~0.5 unless entity @e[type=marker,tag=bulk,distance=..0.3] run summon marker ~ ~ ~ {Tags:[bulk]}
$execute positioned ~ ~1 ~ if block ~ ~ ~ $(id) unless entity @e[tag=smithed.block,dy=0] positioned ~0.5 ~0.5 ~0.5 unless entity @e[type=marker,tag=bulk,distance=..0.3] run summon marker ~ ~ ~ {Tags:[bulk]}
$execute positioned ~ ~1 ~1 if block ~ ~ ~ $(id) unless entity @e[tag=smithed.block,dy=0] positioned ~0.5 ~0.5 ~0.5 unless entity @e[type=marker,tag=bulk,distance=..0.3] run summon marker ~ ~ ~ {Tags:[bulk]}
$execute positioned ~ ~1 ~-1 if block ~ ~ ~ $(id) unless entity @e[tag=smithed.block,dy=0] positioned ~0.5 ~0.5 ~0.5 unless entity @e[type=marker,tag=bulk,distance=..0.3] run summon marker ~ ~ ~ {Tags:[bulk]}
$execute positioned ~ ~-1 ~ if block ~ ~ ~ $(id) unless entity @e[tag=smithed.block,dy=0] positioned ~0.5 ~0.5 ~0.5 unless entity @e[type=marker,tag=bulk,distance=..0.3] run summon marker ~ ~ ~ {Tags:[bulk]}
$execute positioned ~ ~-1 ~1 if block ~ ~ ~ $(id) unless entity @e[tag=smithed.block,dy=0] positioned ~0.5 ~0.5 ~0.5 unless entity @e[type=marker,tag=bulk,distance=..0.3] run summon marker ~ ~ ~ {Tags:[bulk]}
$execute positioned ~ ~-1 ~-1 if block ~ ~ ~ $(id) unless entity @e[tag=smithed.block,dy=0] positioned ~0.5 ~0.5 ~0.5 unless entity @e[type=marker,tag=bulk,distance=..0.3] run summon marker ~ ~ ~ {Tags:[bulk]}
...
$execute positioned ~1 ~ ~-1 if block ~ ~ ~ $(id) unless entity @e[tag=smithed.block,dy=0] positioned ~0.5 ~0.5 ~0.5 unless entity @e[type=marker,tag=bulk,distance=..0.3] run summon marker ~ ~ ~ {Tags:[bulk]}
$execute positioned ~1 ~1 ~ if block ~ ~ ~ $(id) unless entity @e[tag=smithed.block,dy=0] positioned ~0.5 ~0.5 ~0.5 unless entity @e[type=marker,tag=bulk,distance=..0.3] run summon marker ~ ~ ~ {Tags:[bulk]}
$execute positioned ~1 ~1 ~1 if block ~ ~ ~ $(id) unless entity @e[tag=smithed.block,dy=0] positioned ~0.5 ~0.5 ~0.5 unless entity @e[type=marker,tag=bulk,distance=..0.3] run summon marker ~ ~ ~ {Tags:[bulk]}
$execute positioned ~1 ~1 ~-1 if block ~ ~ ~ $(id) unless entity @e[tag=smithed.block,dy=0] positioned ~0.5 ~0.5 ~0.5 unless entity @e[type=marker,tag=bulk,distance=..0.3] run summon marker ~ ~ ~ {Tags:[bulk]}
$execute positioned ~1 ~-1 ~ if block ~ ~ ~ $(id) unless entity @e[tag=smithed.block,dy=0] positioned ~0.5 ~0.5 ~0.5 unless entity @e[type=marker,tag=bulk,distance=..0.3] run summon marker ~ ~ ~ {Tags:[bulk]}
$execute positioned ~1 ~-1 ~1 if block ~ ~ ~ $(id) unless entity @e[tag=smithed.block,dy=0] positioned ~0.5 ~0.5 ~0.5 unless entity @e[type=marker,tag=bulk,distance=..0.3] run summon marker ~ ~ ~ {Tags:[bulk]}
$execute positioned ~1 ~-1 ~-1 if block ~ ~ ~ $(id) unless entity @e[tag=smithed.block,dy=0] positioned ~0.5 ~0.5 ~0.5 unless entity @e[type=marker,tag=bulk,distance=..0.3] run summon marker ~ ~ ~ {Tags:[bulk]}
