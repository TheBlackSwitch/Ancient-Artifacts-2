...
execute if score @s lifetime matches ..40 unless entity @s[type=drowned] at @n[type=marker,tag=necromanced,tag=particles,predicate=theblackswitch:__version__/__patch__/player_id/match_search] run particle block{block_state:"sculk"} ~ ~ ~ 0.6 0.1 0.6 0.1 100 force
execute if score @s lifetime matches ..40 unless entity @s[type=drowned] at @n[type=marker,tag=necromanced,tag=particles,predicate=theblackswitch:__version__/__patch__/player_id/match_search] run particle minecraft:sculk_charge_pop ~ ~ ~ 0.6 0.1 0.6 0 10 force
...
execute if score @s lifetime matches 41 unless entity @s[type=drowned] as @n[type=marker,tag=necromanced,tag=particles,predicate=theblackswitch:__version__/__patch__/player_id/match_search] run kill @s
