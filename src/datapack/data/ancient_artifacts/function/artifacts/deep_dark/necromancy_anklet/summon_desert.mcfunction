summon husk ~ ~-2 ~ {Tags:["necromanced","entity","INIT","tamed",smithed.entity],DeathLootTable:"ancient_artifacts:empty",equipment:{head:{id:"minecraft:gunpowder",count:1,components:{"minecraft:item_model":"ancient_artifacts:entity/sculk_mob"}}},drop_chances:{head:0}, \
    active_effects:[ \
