...
execute as @a[predicate=theblackswitch:__version__/__patch__/player_id/match_search] run scoreboard players add @s inventories_recovered 1
execute as @a[predicate=theblackswitch:__version__/__patch__/player_id/match_search] unless score @s recover_time matches 1.. run scoreboard players set @s recover_time 1200

xp set @s 0 levels
xp set @s 0 points

execute as @a[predicate=theblackswitch:__version__/__patch__/player_id/match_search,tag=recovery_xp] run function ancient_artifacts:artifacts/deep_dark/recovery_anklet/recover/xp
...
kill @n[type=marker,tag=death_location,predicate=theblackswitch:__version__/__patch__/player_id/match_search]

execute unless entity @s[tag=recovery_3] as @a[predicate=theblackswitch:__version__/__patch__/player_id/match_search] run function ancient_artifacts:artifacts/reset