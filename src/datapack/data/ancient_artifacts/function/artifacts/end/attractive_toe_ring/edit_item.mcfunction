particle dust{color:[1.0,0.6,1.0],scale:2} ~ ~ ~ 0.1 0.1 0.1 0.2 4
forceload add 0 0
...
execute if score @s attract_time matches 120.. as @a[predicate=theblackswitch:__version__/__patch__/player_id/match_search] run advancement grant @s only ancient_artifacts:artifacts/end/attractive_expert
