tag @s add deflected
$execute if predicate theblackswitch:__version__/__patch__/rand/$(chance) run return fail
...
scoreboard players add @a[predicate=theblackswitch:__version__/__patch__/player_id/match_search] deflected 1