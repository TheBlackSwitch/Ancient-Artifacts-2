...
# Increase the fireball ring advancement
scoreboard players operation #search tbs.ID = @s tbs.ID
execute if entity @e[type=ghast,distance=..10] run scoreboard players add @a[predicate=theblackswitch:__version__/__patch__/player_id/match_search,limit=1] ghasts_fireballed 1
