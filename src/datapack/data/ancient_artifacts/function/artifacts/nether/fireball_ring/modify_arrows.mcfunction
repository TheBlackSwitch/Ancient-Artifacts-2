summon item_display ~ ~ ~ {Tags:[fireball_ring,INIT,smithed.entity,smithed.strict],billboard:"center",transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[3f,3f,3f]},item:{id:"minecraft:fire_charge",count:1}}
