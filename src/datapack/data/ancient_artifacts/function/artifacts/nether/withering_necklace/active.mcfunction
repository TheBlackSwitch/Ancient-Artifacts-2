...
execute if score #3 tbs.slow_tick matches 3 if predicate theblackswitch:__version__/__patch__/movement_check/sneak run particle minecraft:dust{color:[0.2, 0.1, 0.1],scale:4} ~ ~ ~ 0.2 0 0.2 0 1
...
execute if predicate theblackswitch:__version__/__patch__/movement_check/sneak if score .1 temp matches 30.. run advancement grant @s only ancient_artifacts:artifacts/nether/withering_expert