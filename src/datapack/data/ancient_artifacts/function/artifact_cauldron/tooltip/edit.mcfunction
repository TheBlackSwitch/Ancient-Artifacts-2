...
##Cycling tooltip
execute if score @s current_recipe matches 11..15 if score #40 tbs.slow_tick matches 0..10 align xyz run data modify entity @n[type=text_display,dy=0,tag=artifact_cauldron,tag=tooltip,tag=text] text set value [  \
    {"text":"Artifact Cauldron\n","color":"gold","bold":true},  \
    {"text":"Ancient Artifacts\n\n\n","color":"blue","font":"tooltip_namespace","bold":false},  \
    {"text":"Current Recipe: \n","color":"dark_green","bold":false},{"text":"  Artifact Recycling\n\n","color":"dark_purple"},  \
...
execute if score @s current_recipe matches 11..15 if score #40 tbs.slow_tick matches 11..20 align xyz run data modify entity @n[type=text_display,dy=0,tag=artifact_cauldron,tag=tooltip,tag=text] text set value [  \
    {"text":"Artifact Cauldron\n","color":"gold","bold":true},  \
    {"text":"Ancient Artifacts\n\n\n","color":"blue","font":"tooltip_namespace","bold":false},  \
    {"text":"Current Recipe: \n","color":"dark_green","bold":false},{"text":"  Artifact Recycling\n\n","color":"dark_purple"},  \
    {"text":"Current chances: \n","color":"gold","bold":true},  \
...
execute if score @s current_recipe matches 11..15 if score #40 tbs.slow_tick matches 21..30 align xyz run data modify entity @n[type=text_display,dy=0,tag=artifact_cauldron,tag=tooltip,tag=text] text set value [  \
    {"text":"Artifact Cauldron\n","color":"gold","bold":true},  \
    {"text":"Ancient Artifacts\n\n\n","color":"blue","font":"tooltip_namespace","bold":false},  \
    {"text":"Current Recipe: \n","color":"dark_green","bold":false},{"text":"  Artifact Recycling\n\n","color":"dark_purple"},  \
    {"text":"Current chances: \n","color":"gold","bold":true},  \
...
execute if score @s current_recipe matches 11..15 if score #40 tbs.slow_tick matches 31..40 align xyz run data modify entity @n[type=text_display,dy=0,tag=artifact_cauldron,tag=tooltip,tag=text] text set value [  \
    {"text":"Artifact Cauldron\n","color":"gold","bold":true},  \
    {"text":"Ancient Artifacts\n\n\n","color":"blue","font":"tooltip_namespace","bold":false},  \
    {"text":"Current Recipe: \n","color":"dark_green","bold":false},{"text":"  Artifact Recycling\n\n","color":"dark_purple"},  \
    {"text":"Current chances: \n","color":"gold","bold":true},  \
