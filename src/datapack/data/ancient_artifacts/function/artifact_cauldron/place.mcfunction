...
summon marker ~0.5 ~0.5 ~0.5 {Tags:[artifact_cauldron, control, smithed.entity, smithed.strict, smithed.block]}
summon item_display ~0.5 ~0.5 ~0.5 {Tags:[artifact_cauldron, display, smithed.entity, smithed.strict],item:{id:"minecraft:gold_nugget",components:{"minecraft:item_model":"ancient_artifacts:block/artifact_cauldron"}},item_display:"head"}
summon minecraft:text_display ~0.5 ~0.2 ~0.5 {Rotation:[0f,-90f],Tags:[artifact_cauldron, fluid, smithed.entity, smithed.strict],background:0,teleport_duration:3,text:{"text":"\uE801","color":"blue","font":"ancient_artifacts:main"},alignment:"center"}

##Tooltip background
summon text_display ~0.5 ~0.5 ~0.5 {billboard:"vertical",background:0,teleport_duration:3,Tags:[artifact_cauldron, tooltip, background, smithed.entity, smithed.strict],line_width:200000,alignment:"left",view_range:0.06f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,1f,-0.5f],scale:[1f,1f,1f]},Rotation:[0f, -22f],text:[ \
...
##Tooltip Text
summon text_display ~0.5 ~0.5 ~0.5 {billboard:"vertical",background:0,teleport_duration:3,Tags:[artifact_cauldron, tooltip, text, smithed.entity, smithed.strict],line_width:200000,alignment:"left",view_range:0.06f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0.005f,1.1f,-0.49f],scale:[0.5f,0.5f,0.5f]},Rotation:[0f, -22f],text:[ \
