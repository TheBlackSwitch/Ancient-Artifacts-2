...
##Animation
#reset
execute align xyz if score @s animation matches 0 at @e[tag=ancient_stone,tag=item,dy=0] if score #10 tbs.slow_tick matches 10 run particle trial_spawner_detection ~ ~0.3 ~ 0.3 0.3 0.3 0 1
...
execute if score @s animation matches 5.. if score #20 tbs.slow_tick = #20 tbs.random_delay run playsound block.grindstone.use block @a ~ ~ ~ 1 0
